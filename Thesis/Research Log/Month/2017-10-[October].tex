...
\textbf{Test Type}                & Tensile Test     & Compression Test                               \\ \hline
\textbf{Yield Strength (MPa)}     & (True, @0.2\%)   & 902(Thesis), 1045 (Presentation) (True, @10\%) \\ \hline
\textbf{Strain Rate (s$ ^{-1} $)} & 3.3 x 10$^{-2}$  & 10$^{-3}$                                      \\ \hline
\end{tabular}
\caption{My caption}
\label{my-label}
\end{table}