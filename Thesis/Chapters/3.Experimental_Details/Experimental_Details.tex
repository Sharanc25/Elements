...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{D:/PhD/Thesis/Tensile Test/Images/Ti6242-1.4-TS-Graph}
        \caption{Ti6242-1.4 As Received Tensile Test}
        \label{fig:2a}
    \end{subfigure}
    ~
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{D:/PhD/Thesis/Tensile Test/Images/Ti6242-1.5-TS-Graph}
