...
Mean Area - 397.17 $\mu m^{2}$, Standard Deviation - 275.56 $\mu m^{2}$, E$_{A}$ - 0.703 (95\% Accuracy - ie., 2E$_{A}$).
\\
\textbf{Note:} The area fraction of Ti6242 measured at 100x magnification gave the lowest error and 500x magnification gave the highest error. So all measurements were made for 
