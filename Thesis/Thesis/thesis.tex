...
\def\input@path{
{chapters/1.Introduction/},{chapters/2.Literature_Review/},{chapters/3.Experimental_Details/},{chapters/2.Literature_Review/},{chapters/4.Results_and_Discussion/},{Chapters/5.Summary_and_Conclusions/}
}
...
% Literature Review
\input{Chapters/2.Literature_Review/Literature_Review}
% Experimental Details
\input{Chapters/3.Experimental_Details/Experimental_Details}
% Results and Discussion
\input{Chapters/4.Results_and_Discussion/Results_and_Discussion}
% Summary And Conclusions
\input{chapters/5.Summary_and_Conclusions/Summary_and_Conclusions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
