...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[12pt]{article} %Changed documentstyle to documentclass to upgrade the document to LaTex2e.
...
% Introduction
\subfile{Chapters/1.Introduction/Introduction}
% Literature Review
%\subfile{Chapters/Literature_Review}
% Experimental Details
%\subfile{Chapters/Experimental_Details}
% Results and Discussion
%\subfile{Chapters/Results_and_Discussion}
% Summary And Conclusions
%\subfile{Chapters/Summary_and_Conclusions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%							 Appendix
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
