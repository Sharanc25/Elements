...
\multirow{2}{*}{\textbf{$\alpha+\beta$ forged}} & \multirow{2}{*}{0} & \multirow{2}{*}{870} & 2 Minutes & 2,492 \\
 &  &  & Cyclic & 27,755 \\
\multirow{2}{*}{\textbf{$\beta$ forged}} & \multirow{2}{*}{0} & \multirow{2}{*}{870} & 2 Minutes & 11, 0.90 \\
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{Ti-6246}
    \end{subfigure}
    \caption{\scriptsize Optical Micrograph of As-Received alloys; Magnification - 500x, Marker - 20$\mu m$}  
