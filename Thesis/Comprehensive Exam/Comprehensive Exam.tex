...
{%
\setbeamertemplate{frame footer}{[1]Wikipedia; [2]Bache, 2003; [3]T. NEERAJ{,}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{Dwell Fatigue failure in turbine blade$^[1]$}
        \end{subfigure}
    ~
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{images/Aircraft Dwell Fatigue Schematic.jpg}
        \caption{Dwell Fatigue Schematic for aircraft engine blade$^[2]$}
        \end{subfigure}  
	\\	
