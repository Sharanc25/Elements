...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{\scriptsize Dwell Fatigue failure in turbine blade$^{[1]}$}
        \end{subfigure}
    ~
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{images/Aircraft Dwell Fatigue Schematic.jpg}
        \caption{\scriptsize Dwell Fatigue Schematic for aircraft engine blade$^{[2]}$}
        \end{subfigure}  
	\\	
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{images/Creep.png}
        \caption{\scriptsize Ti-6242 Creep Studies at room temperature$^{[3]}$}
    \end{subfigure}   
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.40\textwidth}
        ...
        \caption{\tiny DFD in Timetal 685$^{[1]}$}
        \end{subfigure}
    ~
