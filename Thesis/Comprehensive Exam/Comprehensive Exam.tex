...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.50\textwidth]{images/BOR Titanium.png}
        %\caption{S-N Curve for Ti-6242}       
\end{figure}

crystallographic relationship with of equiaxed, primary alpha with surrounding beta grains or alpha/alpha grain contact
