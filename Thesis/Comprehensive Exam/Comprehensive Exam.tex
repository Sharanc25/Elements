...
\begin{frame}{Syllabus}
\bf{Mechanical Behavior of materials}. Structure of materials, elastic & plastic properties of materials, plastic flow in single and polycrystals, strengthening mechanisms, thermally activated deformation
\bf{Defects in solids}. Point, line, area and volume defects, Dislocation-solute interaction
\bf{Techniques for microstructural characterization}. Scanning Electron Microscope
\bf{Physical Metallurgy of Titanium alloys}. Basic properties, crystal structure, deformation modes, phase diagrams, phase transformations, alloy classification, basic hardening mechanisms, effect of processing and composition on microstructure and mechanical properties, high temperature titanium alloys.
