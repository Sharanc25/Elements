...
{%
\setbeamertemplate{frame footer}{[1]T.Neeraj et al (2000)}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{Ti-6242 Creeping at room temperature $^{[1]}$}
    \end{subfigure}    
\end{figure}

Dwell Fatigue Debit - $ \dfrac{No. of Cycles to Failure in cyclic Fatigue}{No. of Cycles to Failure in Dwell Fatigue} $  
