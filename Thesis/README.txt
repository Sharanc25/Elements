...
3. Each directory (like Tensile Test, Texture, etc..) which contains data, contains a "Image" folder. This
   folder consists of all images that go into the thesis. The original images are kept in their respective folders.
