...
\begin{figure}[H]
    ...
    \begin{subfigure}[H]{0.40\textwidth}
        \includegraphics[width=\textwidth]{"Projected Image"}
    \end{subfigure}
    ~
    \begin{subfigure}[H]{0.40\textwidth}
        \includegraphics[width=\textwidth]{"Projection of Structural Features"}
    \end{subfigure}       
...
\begin{figure}[H]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{"Projection of Structural Features"}
