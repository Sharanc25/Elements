...
\begin{figure}[H]
\includegraphics[width=0.90\textwidth,height=\textheight,keepaspectratio]{"Jefferies"}
\end{figure}

CircleD iameter = 79.8 mm. \\
...
{%
\setbeamertemplate{frame footer}{Z. Jeffries, A.H. Kline and E.B. Zimmer, Trans. AIME, Vol. 54, 1916, pp. 594-607}
\begin{frame}[fragile]{Jeffries Planimetric Method (ASTM E112) - Contd.}
